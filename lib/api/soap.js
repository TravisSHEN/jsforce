 ...
 */
var SoapApi = module.exports = function(conn, options) {
  this._conn = conn;
...
SoapApi.prototype._invoke = function(method, message, schema, callback) {
  ...
  options = _.merge(options, this._options);

  var soapEndpoint = new SOAP(this._conn, options);
...
jsforce.on('connection:new', function(conn) {
  conn.soap = function(options) {
    return new SoapApi(conn, options);
  };
});
